...
newLocal = api.defaults.headers.common["Access-Control-Allow-Methods"] = 
...
multipartApi.defaults.headers.common["Access-Control-Allow-Methods"] = 
"GET, POST, OPTIONS,DELETE, PATCH, PUT";
multipartApi.defaults.headers.common["Access-Control-Allow-Headers"] = 
"Origin, Content-Type, Accept";

export { api, multipartApi };
newLocal = api.defaults.headers.common["Access-Control-Allow-Methods"] = "GET, POST, OPTIONS,DELETE, PATCH, PUT";
